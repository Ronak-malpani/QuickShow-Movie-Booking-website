             ...
             rounded-xl h-104 max-w-70 object-cover'/>
                ...
                <div className='relative flex flex-col gap-3'>
                    ...
                    <div className='flex items-center gap-2 text-gray-300'>
                        ...
                        {Number(show.movie.vote_average)
                    ...
                    <p>
                        ...
                        {timeformat((Array.isArray(show.movie.run_time) && show.movie.run_time[0]) || 0)} • {show.movie.genres.map(genre => genre.name).join(", ")} • {show.movie.release_date.split("-")[0]}
                    </p>
                    <div className='flex items-center flex-wrap gap-4 mt-4'>
                        ...
                        <button onClick={handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition  cursor-pointer active:scale-99'>
