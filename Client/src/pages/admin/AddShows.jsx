    ...
    return nowPlayingMovies.length >0 ?(
        <>
            ...
            {/*Display Selected Times */}
                {Object.keys(dateTimeSelection).length > 0 && (
                    <div className="mt-6">
                        ...
                        <ul className="space-y-3">
                            {Object.entries(dateTimeSelection).map(([date, times])=>(<li key={date}>
                ...
                <button onClick={handleSubmit} disabled={addingShow} className=
                "bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer">Add Show</button>
        </>
    ) : <Loading />
}
